...
| Tools | `ctx.tools.register(ToolDefinition)`; schema enters prompt; calls traverse pre/execute/post waterfalls | Five domain tools return canonical JSON values |
...
Harness Agent Loop / native Subagents
       ...
       KernelPilot plugin
       /              \
 five guarded tools   nine CUDA skills
       |
